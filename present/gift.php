...
<title>無料プレゼント|株式会社いないいないばぁ</title>
...
<meta property="og:title" content="無料プレゼント|株式会社いないいないばぁ" />
...
<link rel="alternate" media="only screen and (max-width: 727px)" href="http://www.i-i-b.jp/sp/present/gift.php" />
</head>
...
<div id="content-wrap" class="present"><!-- content-wrap -->

<section id="Gift">
<div id="ContBlock">
<div class="Title"><h2><img src="../common/img/present/common/h2.png" width="128" height="31" alt="無料プレゼント"/></h2><p class="SubTitle">無料プレゼント</p>
</div>

<div class="Block BlockTop">
	<div class="Inner">
		<h3>無料プレゼントダウンロードページ</h3>
		<div class="Box">
			<p class="Img"><img src="../common/img/present/common/present-top.png"></p>
			<p class="GiftTxt">星の数ほど多いサイトの中から<br>
			私たちの元を訪れていただきありがとうございます!!</p>
			<p class="GiftTxt">さらにはこんなところまでたどり着いていただいた<br>
			感謝の気持ちとして、いないいないばぁからプレゼントをいたします。</p>
			<p class="GiftTxt endnote">ここでしか手に入らない珠玉のプレゼントをご用意いたしますので、<br>
			興味のある方は下記からご登録を済ませておいてください。</p>
		</div>
		<div class="Box">
			<div class="GiftBox">
				<h4>登録フォーム</h4>
				...
				<div id="btn-sendMail"><input id="send" type="button" onclick="submit();"><label class="btn animation opacity btn-lunch btn-act" for="send">え、押しちゃうの・・・</label></div>
