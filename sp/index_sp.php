  ...
  <div class="container">
    ...
    <section class="message_zone">
      ...
      <ul class="news_zone">
        <?php foreach($item_all2 as $v2): ?>
          ...
          <p class="txt"><?php echo $v2['name']; ?></p>
          </a>
        </li>
        <?php endforeach; ?>
        <!--
    ...
    <section class="monster_zone">
      ...
      <div class="txtzone">
        ...
        <p class="btn">
          <a href="member.php"><img src="common/img/btn_go_01.png" alt="GO！！"></a>
        </p>
      </div>
    </section>
    <!--Surprise Island-->
    ...
    <section class="blog_zone">
      ...
      <ul class="list">
        <li>
          ...
          <p class="btn"><a href="article.php"><img src="common/img/btn_go_03.png" alt="GO！！"></a></p>
        </li>
      </ul>
    </section>
    <!--Present Island-->
