...
$(document).ready(function(){
  ...
  $('.serviceblock').css("display","none");
  $('.surpriseblock').css("display","none");
  $('.presentblock').css("display","none");
...
setTimeout(function(){$("#ActionBlock01 .Action01 .Act1-2").css("display","block").fadeIn();},1500);
setTimeout(function(){
...
$("#ActionBlock02").fadeOut();
  ...
  $("#ServiceBlock .btn01").click(function(){
    $('.serviceblock').css("display","block");
  ...
  $("#SurpriseBlock .btn01").click(function(){
    $('.surpriseblock').css("display","block");
  ...
  $("#PresentBlock .btn01").click(function(){
    $('.presentblock').css("display","block");
