...
//メール設定
$ARYconf['hensinMailSubject']	= '【株式会社いないいないばぁ】お問い合わせありがとうございます。';
$ARYconf['hensinMailTemplate']	= 'hensinMail.dat';
$ARYconf['clientMailSubject']	= '【株式会社いないいないばぁ】お問い合わせがありました。';
$ARYconf['clientMailTemplate']	= 'clientMail.dat';

//表示文言
$ARYconf['hissu']['f_name']			= '<p class="fc-red">お名前を入力してください。</p>';
$ARYconf['hissu']['f_title']			= '<p class="fc-red">依頼ジャンルを選択してください。</p>';
